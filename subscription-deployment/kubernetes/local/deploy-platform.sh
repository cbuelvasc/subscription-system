...
echo "📦 Deploying PostgreSQL Subscription..."

kubectl apply -f platform/postgres-subscription.yml
...
echo "📦 Deploying PostgreSQL Keycloak..."

kubectl apply -f platform/postgres-keycloak.yml
